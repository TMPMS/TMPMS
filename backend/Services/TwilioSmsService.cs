...
namespace TMPMS.Services
{
    public class TwilioSmsService : ISmsService
    {
        ...
        public async Task<bool> SendSmsAsync(string toPhoneNumber, string message)
        {
            ...
            // Nếu chưa cấu hình Twilio, log ra console và trả về true để phát triển local dễ dàng
            ...
            try
            {
                // Chuẩn hóa định dạng số điện thoại Việt Nam sang định dạng quốc tế (+84...)
